...
def novo_jogo():
    ...
    vocabulario = ["FUJA", "LUTE", "PEGUE", "SAIA", "AJUDA", "FALE", "ABRA", "ENTRE", "LISTE", "TOQUE", "DESCANSE", "DESISTA"] # vo
    ...
    locais = ["A ENTRADA DA CASA", "O HALL", "O CORREDOR", "A ESCADA", "O QUARTO", "A GARAGEM", "A SALA", "O SALAO DE JOGOS", "A BIBLIOTECA", "A PORTA DOS FUNDOS", "A DESPENSA", "A COZINHA", "O BANHEIRO", "O GRAMADO", "O MURO", "A ARCA", "A PASSAGEM SECRETA", "O CASTELO VERMELHO", "O DIAMANTE", "O CAMPO ZERO"] # lo
